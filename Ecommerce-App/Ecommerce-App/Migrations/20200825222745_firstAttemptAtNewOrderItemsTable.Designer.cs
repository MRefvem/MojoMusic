...
namespace Ecommerce_App.Migrations
{
    ...
    [Migration("20200825222745_firstAttemptAtNewOrderItemsTable")]
    partial class firstAttemptAtNewOrderItemsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce_App.Models.Cart", b =>
                {
                    ...
                    b.Property<int?>("OrderItemsProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderItemsOrderId", "OrderItemsProductId");
            ...
            modelBuilder.Entity("Ecommerce_App.Models.OrderItems", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce_App.Models.Cart", b =>
                {
                    b.HasOne("Ecommerce_App.Models.OrderItems", "OrderItems")
                        .WithMany()
                        .HasForeignKey("OrderItemsOrderId", "OrderItemsProductId");
                });
            ...
            modelBuilder.Entity("Ecommerce_App.Models.OrderItems", b =>
                {
                    b.HasOne("Ecommerce_App.Models.Order", "Order")
                        .WithOne("OrderItems")
                        .HasForeignKey("Ecommerce_App.Models.OrderItems", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
